...
if __name__ == "__main__":
    ...
    if MLFLOW_AVAILABLE:
        try:
            ...
            logger.warning("Skipping MLflow logging because the tracking server is unavailable: %s", exc)
    else:
        logger.info("Skipping MLflow logging because the tracking server is unavailable")
